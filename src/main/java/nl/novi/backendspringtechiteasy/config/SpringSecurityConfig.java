package nl.novi.backendspringtechiteasy.config;

import nl.novi.backendspringtechiteasy.filter.JwtRequestFilter;
...
public class SpringSecurityConfig {
    ...
    public SpringSecurityConfig(CustomUserDetailsService customUserDetailsService, JwtRequestFilter jwtRequestFilter, CustomPasswordEncoder encoder) {
